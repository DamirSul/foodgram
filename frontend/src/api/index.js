class Api {
  ...
  resetPassword({ email }) {
    return fetch(`/api/v1/users/reset_password/`, {
      method: "POST",
      headers: {
        ...this._headers,
      },
  ...
  addToFavorites({ id }) {
    const token = localStorage.getItem("token");
    return fetch(`/api/v1/recipes/${id}/favorite/`, {
      method: "POST",
      headers: {
        ...this._headers,
        authorization: `Token ${token}`,
  ...
  copyRecipeLink({ id }) {
    return fetch(`/api/v1/recipes/${id}/get-link/`, {
      method: "GET",
      headers: {
        ...this._headers,
      },
  ...
  deleteSubscriptions({ author_id }) {
    const token = localStorage.getItem("token");
    return fetch(`/api/v1/users/${author_id}/subscribe/`, {
      method: "DELETE",
      headers: {
        ...this._headers,
        authorization: `Token ${token}`,
  ...
  getIngredients({ name }) {
    const token = localStorage.getItem("token");
    return fetch(`/api/v1/ingredients/?name=${name}`, {
      method: "GET",
      headers: {
        ...this._headers,
      },
  ...
  addToOrders({ id }) {
    const token = localStorage.getItem("token");
    return fetch(`/api/v1/recipes/${id}/shopping_cart/`, {
      method: "POST",
      headers: {
        ...this._headers,
        authorization: `Token ${token}`,
  ...
  downloadFile() {
    const token = localStorage.getItem("token");
    return fetch(`/api/v1/recipes/download_shopping_cart/`, {
      method: "GET",
      headers: {
        ...this._headers,
        authorization: `Token ${token}`,
